...
- `src/lib/sync/atomicWrite.ts`: `.part`, rilettura con lunghezza e SHA-256, `move` se c'è, fallback su `NotSupportedError` e `NotAllowedError` (Chrome rifiuta `move` sui file locali in modo intermittente, visto in prova il 14/9/2026).
